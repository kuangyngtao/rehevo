        ...
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="px-6 py-5 space-y-5">
                ...
                <AnimatePresence>
                  {config.showMore && (
                    ...
                    >
                      {/* 简历选择 */}
                      <div className="rounded-2xl border border-primary-100 bg-primary-50/70 p-4 dark:border-primary-900/60 dark:bg-primary-950/25">
              ...
              {/* Footer */}
              <div className="rounded-b-[28px] border-t border-slate-100 bg-slate-50/70 px-6 py-4 dark:border-slate-800 dark:bg-slate-950/30">
                <div className="flex gap-3">
                  <motion.button
                    onClick={onClose}
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="flex-1 rounded-xl border border-slate-200 px-5 py-3 text-sm font-medium text-slate-700 transition-all hover:bg-white dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"
                  >
                    取消
                  </motion.button>
                  <motion.button
                    ...
                    className="flex-1 rounded-xl bg-primary-600 px-5 py-3 text-sm font-semibold text-white shadow-md shadow-primary-600/20 transition-all hover:bg-primary-700 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    {startButtonText}
                  </motion.button>
                </div>
