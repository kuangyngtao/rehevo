  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-12">
        <motion.h1
            className="text-4xl md:text-5xl font-bold text-slate-950 dark:text-white mb-4 tracking-tight"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
      ...
      {/* 上传区域 */}
      <motion.div
          className={`relative bg-white dark:bg-slate-900 rounded-[28px] border-2 border-dashed p-12 cursor-pointer transition-all duration-300
          ${dragOver ? 'border-primary-400 bg-primary-50/40 scale-[1.01] shadow-lg shadow-primary-500/10' : 'border-slate-200 dark:border-slate-700 shadow-[0_18px_45px_-32px_rgba(24,34,53,0.45)] hover:border-primary-300'}`}
          ...
          <AnimatePresence mode="wait">
            {selectedFile ? (
              ...
              >
                ...
                <div
                    className="flex items-center justify-center gap-4 bg-slate-50 dark:bg-slate-950/50 px-6 py-4 rounded-2xl max-w-md mx-auto border border-slate-100 dark:border-slate-800">
              ...
              >
                ...
                <motion.button
                  className="bg-primary-600 text-white px-8 py-3.5 rounded-xl font-semibold shadow-md shadow-primary-500/20 hover:bg-primary-700 transition-all"
      ...
      {showNameInput && selectedFile && (
        <motion.div
            className="mt-6 bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-200/80 dark:border-slate-800 shadow-sm"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        >
      ...
      <div className="mt-8 flex gap-4 justify-center">
        ...
        {selectedFile && (
          <motion.button
            ...
            disabled={uploading}
            className="px-8 py-3 bg-emerald-600 text-white rounded-xl font-semibold shadow-md shadow-emerald-500/20 hover:bg-emerald-700 transition-all disabled:opacity-60 disabled:cursor-not-allowed flex items-center gap-2"
