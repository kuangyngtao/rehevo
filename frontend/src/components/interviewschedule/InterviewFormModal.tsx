    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-end gap-3">
        ...
        <motion.button
          ...
          className="rounded-xl bg-primary-600 px-5 py-2.5 font-medium text-white shadow-md shadow-primary-600/20 transition-all hover:bg-primary-700 disabled:cursor-not-allowed disabled:opacity-50"
        >
          {parsing ? '解析中...' : '解析文本'}
        </motion.button>
      </div>
    ...
    <div className="space-y-6">
        ...
        <>
          <div className={`rounded-2xl border p-5 ${
            ...
            {parseResult.success && parseResult.data && (
              <div className="space-y-2.5 rounded-xl border border-emerald-100 bg-white/90 p-4 text-sm dark:border-emerald-900/60 dark:bg-slate-950/40">
                <div className="flex">
          ...
          <details className="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-900/60">
            ...
            <pre className="mt-3 overflow-auto whitespace-pre-wrap rounded-xl border border-slate-200 bg-white p-3 font-mono text-xs text-slate-600 dark:border-slate-800 dark:bg-slate-950/50 dark:text-slate-400">
              {parseResult.log}
            </pre>
          </details>
        </>
      ...
      <div className="flex justify-between gap-3">
        ...
        <motion.button
          ...
          type="button"
          onClick={() => setStep('form')}
          className="flex items-center gap-2 rounded-xl bg-primary-600 px-5 py-2.5 font-medium text-white shadow-md shadow-primary-600/20 transition-all hover:bg-primary-700"
        >
      ...
      <div className="flex justify-between pt-5 gap-3">
        ...
        <div className="flex gap-3 ml-auto">
          ...
          <motion.button
            ...
            type="submit"
            disabled={submitting}
            className="rounded-xl bg-primary-600 px-6 py-2.5 font-medium text-white shadow-md shadow-primary-600/20 transition-all hover:bg-primary-700 disabled:cursor-not-allowed disabled:opacity-50"
          >
            {submitting ? '保存中...' : '保存'}
          </motion.button>
        </div>
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-[28px] border border-slate-200/80 bg-white shadow-2xl dark:border-slate-800 dark:bg-slate-900"
      >
        <div className="flex items-center justify-between border-b border-slate-100 p-6 dark:border-slate-800">
          <h2 className="text-2xl font-display font-bold tracking-tight text-slate-950 dark:text-white">
            {mode === 'edit' ? '编辑面试' : '添加面试'}
          </h2>
          <motion.button
