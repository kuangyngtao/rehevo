...
export const InterviewListItem: React.FC<InterviewListItemProps> = ({
  ...
  return (
    <motion.div
      ...
      className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm transition-all hover:border-primary-100 hover:shadow-md dark:border-slate-800 dark:bg-slate-900 dark:hover:border-primary-900/60"
    >
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex gap-2">
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={onEdit}
            className="rounded-xl p-2.5 text-slate-400 transition-colors hover:bg-primary-50 hover:text-primary-600 dark:text-slate-500 dark:hover:bg-primary-950/40 dark:hover:text-primary-300"
            title="编辑"
          >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={onDelete}
            className="rounded-xl p-2.5 text-slate-400 transition-colors hover:bg-red-50 hover:text-red-600 dark:text-slate-500 dark:hover:bg-red-950/40 dark:hover:text-red-300"
            title="删除"
          >
