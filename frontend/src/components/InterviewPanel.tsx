  ...
  if (interviews.length === 0) {
    return (
        ...
        <motion.button
          ...
          className="rounded-xl bg-primary-600 px-6 py-3 font-medium text-white shadow-md shadow-primary-600/20 transition-colors hover:bg-primary-700"
      ...
      >
        ...
        {loadingInterview && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 p-4 backdrop-blur-sm">
              <div className="flex items-center gap-4 rounded-2xl border border-slate-200/80 bg-white p-6 shadow-2xl dark:border-slate-800 dark:bg-slate-900">
                <motion.div
...
function InterviewItemCard({
  ...
  return (
    <motion.div
      ...
      onClick={onView}
      className="group flex cursor-pointer items-center gap-4 rounded-xl border border-slate-100 bg-slate-50 p-4 transition-colors hover:border-primary-100 hover:bg-primary-50/40 dark:border-slate-800 dark:bg-slate-950/20 dark:hover:border-primary-900/60 dark:hover:bg-primary-950/20"
    >
      {/* 得分 */}
