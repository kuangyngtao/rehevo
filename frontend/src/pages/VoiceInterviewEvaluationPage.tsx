  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[50vh]">
        <div className="text-center bg-white dark:bg-slate-900 rounded-[28px] border border-slate-200/80 dark:border-slate-800 shadow-sm px-10 py-9">
      ...
      <div className="flex items-center justify-center min-h-[50vh]">
        <div className="text-center bg-white dark:bg-slate-900 rounded-[28px] border border-slate-200/80 dark:border-slate-800 shadow-sm px-10 py-9">
          ...
          <div className="flex items-center gap-3 justify-center">
            <button
              onClick={handleRetry}
              className="px-6 py-2.5 bg-primary-600 text-white rounded-xl hover:bg-primary-700 shadow-md shadow-primary-500/20 flex items-center gap-2"
            >
            ...
            <button
              ...
              className="px-6 py-2.5 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-xl hover:bg-slate-200 dark:hover:bg-slate-700"
            >
              返回列表
            </button>
          </div>
    ...
    <div className="pb-10">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center gap-3 mb-8">
          <button
            onClick={() => navigate('/interviews')}
            className="p-2.5 text-slate-500 hover:text-slate-700 hover:bg-white dark:hover:bg-slate-800 rounded-xl border border-transparent hover:border-slate-200 dark:hover:border-slate-700 transition-colors"
          >
            <ArrowLeft className="w-5 h-5" />
          </button>
          <div>
            <div className="text-sm font-semibold text-primary-600 dark:text-primary-400 mb-2">Rehevo Review</div>
            <h1 className="text-3xl font-bold text-slate-950 dark:text-white">面试评估报告</h1>
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">语音会话 ID: {sessionId}</p>
          </div>
        </div>
