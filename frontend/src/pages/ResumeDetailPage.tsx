    ...
    >
      ...
      <div className="flex justify-between items-center mb-10 flex-wrap gap-4">
        <div className="flex items-center gap-4">
            ...
            className="w-10 h-10 bg-white dark:bg-slate-900 rounded-xl flex items-center justify-center text-slate-500 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-700 dark:hover:text-slate-300 transition-all border border-slate-200/80 dark:border-slate-800 shadow-sm"
        ...
        <div className="flex gap-3">
          {detailView === 'interviewDetail' && selectedInterview && (
            <motion.button
              ...
              className="px-5 py-2.5 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 rounded-xl text-slate-600 dark:text-slate-300 font-medium hover:bg-slate-50 transition-all disabled:opacity-50 flex items-center gap-2"
          ...
          {detailView !== 'interviewDetail' && (
            <motion.button
              ...
              className="px-5 py-2.5 bg-primary-600 text-white rounded-xl font-medium shadow-md shadow-primary-500/20 hover:bg-primary-700 transition-all flex items-center gap-2"
      ...
      {/* 标签页切换 - 仅在非面试详情时显示 */}
      {detailView !== 'interviewDetail' && (
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-2 mb-6 inline-flex gap-1 border border-slate-200/80 dark:border-slate-800 shadow-sm">
          {tabs.map((tab) => (
            <motion.button
              key={tab.id}
            ...
            >
              {activeTab === tab.id && (
                <motion.div
                  layoutId="activeTab"
                  className="absolute inset-0 bg-primary-50 dark:bg-primary-950/50 rounded-xl"
