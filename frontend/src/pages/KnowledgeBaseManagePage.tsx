...
function StatCard({
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-200/80 dark:border-slate-800"
    >
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-10">
        <div>
          ...
          <h1 className="text-4xl font-bold text-slate-950 dark:text-white">知识库管理</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-3">把值得反复推敲的材料，放进每一次准备里。</p>
        </div>
        <div className="flex gap-3">
          <button
            onClick={onUpload}
            className="flex items-center gap-2 px-4 py-2.5 bg-primary-600 text-white rounded-xl hover:bg-primary-700 shadow-md shadow-primary-500/20 transition-colors"
          >
          ...
          <button
            onClick={onChat}
            className="flex items-center gap-2 px-4 py-2.5 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 rounded-xl border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
          >
      ...
      {/* 搜索和筛选栏 */}
        <div
            className="bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-sm border border-slate-200/80 dark:border-slate-800 mb-6">
        <div className="flex flex-wrap items-center gap-4">
          ...
          <form onSubmit={handleSearch} className="flex-1 min-w-[200px]">
            <div className="relative">
              ...
              <input
                ...
                placeholder="搜索知识库名称..."
                className="w-full pl-10 pr-4 py-2.5 border border-slate-200 dark:border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-slate-50/70 dark:bg-slate-950/40 text-slate-900 dark:text-white"
              />
            </div>
          </form>
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none pl-4 pr-10 py-2.5 border border-slate-200 dark:border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 bg-slate-50/70 dark:bg-slate-950/40 text-slate-900 dark:text-white cursor-pointer"
            >
      ...
      {/* 知识库列表 */}
        <div
            className="bg-white dark:bg-slate-900 rounded-[28px] shadow-[0_18px_45px_-32px_rgba(24,34,53,0.45)] border border-slate-200/80 dark:border-slate-800 overflow-hidden">
        {loading ? (
          ...
          <table className="w-full">
              <thead className="bg-slate-50/80 dark:bg-slate-950/40 border-b border-slate-100 dark:border-slate-800">
              <tr>
