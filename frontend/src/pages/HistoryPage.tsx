    ...
    >
      ...
      <div className="flex items-center justify-between mb-10">
        <div>
          ...
          <h1 className="text-4xl font-bold text-slate-950 dark:text-white">简历管理</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-3">让你的经历成为下一次面试中更有把握的表达。</p>
        </div>
      ...
      {/* 搜索栏 */}
      <div className="mb-6">
        <div className="flex items-center gap-3 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-700 rounded-2xl px-4 py-3 max-w-md shadow-sm shadow-slate-200/50 focus-within:border-primary-500 focus-within:ring-2 focus-within:ring-primary-100 transition-all">
      ...
      {!loading && filteredResumes.length === 0 && (
        <motion.div
          className="text-center py-20 bg-white dark:bg-slate-900 rounded-[28px] border border-slate-200/80 dark:border-slate-800 shadow-[0_18px_45px_-32px_rgba(24,34,53,0.45)]"
            ...
            <AnimatePresence>
              {filteredResumes.map((resume, index) => (
                <motion.tr
                  ...
                  className="border-b border-slate-100 dark:border-slate-800 last:border-0 hover:bg-primary-50/35 dark:hover:bg-primary-950/20 cursor-pointer transition-colors group"
                >
