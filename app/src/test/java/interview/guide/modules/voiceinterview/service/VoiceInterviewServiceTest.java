...
class VoiceInterviewServiceTest {
    ...
    class CreateSessionTests {
        ...
        void testCreateSession() {
            ...
            verify(bucket).set(any(VoiceInterviewSessionEntity.class), eq(Duration.ofHours(1)));
        }
    ...
    class ResumeSessionTests {
        ...
        void testResumeSession_LoadsConversationHistory() {
            ...
            verify(bucket).set(same(pausedSession), eq(Duration.ofHours(1)));
        }
    ...
    class PhaseTransitionTests {
        ...
        void testStartPhase_IntroToTech() {
            ...
            verify(sessionRepository, times(1)).save(session);
            verify(bucket).set(same(session), eq(Duration.ofHours(1)));
        }
