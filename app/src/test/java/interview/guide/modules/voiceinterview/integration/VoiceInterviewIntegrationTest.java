...
class VoiceInterviewIntegrationTest {
    ...
    class CompleteInterviewFlowTests {
        ...
        void testCompleteInterviewFlow() {
            ...
            assertEquals("java-backend", sessionResponse.getRoleType());
            ...
            assertEquals("java-backend", savedSession.getRoleType());
        ...
        void testSessionPersistence() {
            ...
            assertEquals("java-backend-tencent", dbSession.getRoleType());
    ...
    class ErrorHandlingTests {
        ...
        @Test
        @DisplayName("处理不同技能模板")
        void testDifferentSkillIds() {
            String[] skillIds = {"java-backend", "bytedance-backend", "java-backend-tencent"};
